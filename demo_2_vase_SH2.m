...
options.tolEps = 1e-9; % Stopping criterion (primal dual gap)
options.beta = 1e2; % Initial stepsize on theta for ADMM iterations
...
options.maxit_bfgs = 50; % Stoppbetaing criterion for the inner BFGS iterations
